...
public class CalenderActivity extends Activity {
    ...
    List<CalendarCollection> djList;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_calender);
        //("2015-04-01", "John Birthday"));
        CalendarCollection c1 = new CalendarCollection("2016-03-20","test msg");
       // c1.setDate("2016-03-20");
      //  c1.setEvent_message("test msg");
//        djList.add(c1);
